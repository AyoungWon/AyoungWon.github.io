...
우리 조는 불만을 품고 떠난 사람은 없었다. 다들 브레인스토밍을 시작으로 차근차근 기획을 진행했고,  
...
조원들 대부분이 3~4년 차 개발자였기 때문에, 해당 기능을 구현하는 데 큰 어려움이 없어,
도전 의식이 생기지 않아 흥미를 잃을 수도 있었다. 그래서 프론트엔드 팀원 3명(나 포함)은 **"회사에서는 하지 못했던 것들을 이곳에서 해보자"**라는 목표를 세우고 프로젝트에 임했다.
